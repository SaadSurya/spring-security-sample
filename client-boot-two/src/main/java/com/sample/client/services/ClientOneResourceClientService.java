...
@Service
public class ClientOneResourceClientService {
    @Value("${clientone.resource.url:}")
    private String clientOneResourceUrl;

    private final WebClient webClient;
    private final OAuth2AuthorizedClientService authorizedClientService;

    public ClientOneResourceClientService(
            WebClient webClient,
